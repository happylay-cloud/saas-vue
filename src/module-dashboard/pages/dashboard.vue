  ...
  <div class="dashboard-container">
    <el-card class="sales-card">
      <div class="clearfix">
        <div class='fl headL'>
          <div class="headImg">
            <img src="../../assets/head.png" width="100px" height="100px"/>
          </div>
          <div class="headInfoTip">
            <p class="firstChild">早安，快乐的小绵羊！</p>
            <p class="lastChild">小绵羊  |  开心-技术部-小绵羊</p>
          </div>
        </div>
        <div class="fr">
                ...
                <ul class="noticeList">
                  <li>
                    <div class="item">
                        ...
                        <div>
                          <p><span class="col">XXX</span> 发布了 第二十期XXX公布</p>
                          <p>2019-11-20 10:30:30</p>
                        </div>
                      </div>
                  </li>
                  <li>
